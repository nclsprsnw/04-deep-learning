...
│                         at&t_spam_detector and configuration for tools like black
│
...
│
└── at&t_spam_detector   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes at&t_spam_detector a Python module
    │
